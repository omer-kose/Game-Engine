...
/*
    Variadic arguments in clang and gcc is handled with the keyword ##__VA_ARGS__
*/
...
#define KWARN(message, ...) // This defines the call as nothing. So, when this is not defined the call is removed entirely.
#endif
