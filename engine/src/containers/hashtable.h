...
/**
 * @brief Represents a simple hashtable with string keys. Members of this structure
 ...
 * 
 * This hashtable has a fixed size. It will not get resized as it grows. So, once it is full, it is full.
 */
