...
/*
    Nvidia cards wants uniform objects to be 256 bytes
*/  
...
/*
    Object specific uniform object.
*/
...
/*
    A packet that is required for rendering with the information needed to draw a frame
*/
