...
/*
    We are declaring them as macros, so that we can use __FILE__ and __LINE__ which is very nice as 
    it allows us to click and go to that place in the console
*/
